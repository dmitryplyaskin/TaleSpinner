...
| ALL | /api/config/openrouter | `server/src/api/llm.api.ts` | L257 |
...
| GET | /api/llm/models | `server/src/api/llm.api.ts` | L216 |
| GET | /api/llm/providers | `server/src/api/llm.api.ts` | L53 |
| POST | /api/llm/providers/:providerId/check | `server/src/api/llm.api.ts` | L132 |
| GET | /api/llm/providers/:providerId/config | `server/src/api/llm.api.ts` | L103 |
| PATCH | /api/llm/providers/:providerId/config | `server/src/api/llm.api.ts` | L113 |
| GET | /api/llm/runtime | `server/src/api/llm.api.ts` | L68 |
| PATCH | /api/llm/runtime | `server/src/api/llm.api.ts` | L86 |
| GET | /api/llm/tokens | `server/src/api/llm.api.ts` | L154 |
| POST | /api/llm/tokens | `server/src/api/llm.api.ts` | L172 |
| DELETE | /api/llm/tokens/:id | `server/src/api/llm.api.ts` | L207 |
| PATCH | /api/llm/tokens/:id | `server/src/api/llm.api.ts` | L193 |
...
| DELETE | /api/operation-blocks/:id | `server/src/api/operation-blocks.core.api.ts` | L79 |
| GET | /api/operation-blocks/:id | `server/src/api/operation-blocks.core.api.ts` | L53 |
| PUT | /api/operation-blocks/:id | `server/src/api/operation-blocks.core.api.ts` | L64 |
| GET | /api/operation-blocks/:id/export | `server/src/api/operation-blocks.core.api.ts` | L93 |
| POST | /api/operation-blocks/import | `server/src/api/operation-blocks.core.api.ts` | L118 |
...
| DELETE | /api/operation-profiles/:id | `server/src/api/operation-profiles.core.api.ts` | L107 |
| GET | /api/operation-profiles/:id | `server/src/api/operation-profiles.core.api.ts` | L81 |
| PUT | /api/operation-profiles/:id | `server/src/api/operation-profiles.core.api.ts` | L92 |
| GET | /api/operation-profiles/:id/export | `server/src/api/operation-profiles.core.api.ts` | L121 |
...
| POST | /api/operation-profiles/import | `server/src/api/operation-profiles.core.api.ts` | L135 |
