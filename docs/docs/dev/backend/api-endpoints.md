...
| GET | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L841 |
| POST | /api/chats/:id/entries | `server/src/api/chat-entries.api.ts` | L897 |
| POST | /api/chats/:id/entries/continue | `server/src/api/chat-entries.api.ts` | L1089 |
| PUT | /api/chats/:id/instruction | `server/src/api/chats.core.api.ts` | L44 |
| GET | /api/chats/:id/world-info/latest-activations | `server/src/api/chat-entries.api.ts` | L1424 |
...
| POST | /api/entries/:id/manual-edit | `server/src/api/chat-entries.api.ts` | L1825 |
| POST | /api/entries/:id/parts/batch-update | `server/src/api/chat-entries.api.ts` | L1929 |
| GET | /api/entries/:id/prompt-diagnostics | `server/src/api/chat-entries.api.ts` | L1371 |
| POST | /api/entries/:id/prompt-visibility | `server/src/api/chat-entries.api.ts` | L2039 |
| POST | /api/entries/:id/regenerate | `server/src/api/chat-entries.api.ts` | L1230 |
| POST | /api/entries/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L2025 |
| GET | /api/entries/:id/variants | `server/src/api/chat-entries.api.ts` | L1448 |
| POST | /api/entries/:id/variants/:variantId/select | `server/src/api/chat-entries.api.ts` | L1465 |
| POST | /api/entries/:id/variants/:variantId/soft-delete | `server/src/api/chat-entries.api.ts` | L1972 |
| POST | /api/entries/soft-delete-bulk | `server/src/api/chat-entries.api.ts` | L2012 |
...
| POST | /api/parts/:id/canonicalization-undo | `server/src/api/chat-entries.api.ts` | L2138 |
| POST | /api/parts/:id/soft-delete | `server/src/api/chat-entries.api.ts` | L2188 |
