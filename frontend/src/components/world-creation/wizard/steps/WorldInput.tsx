    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
      <Box sx={{ textAlign: "center", mb: 2 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Расскажите о мире, который хотите создать. Упомяните фракции, локации, атмосферу или особых персонажей.
      ...
      >
        <Typography variant="body2" color="info.light">
          💡 <strong>Совет:</strong> Вы можете описать мир кратко или подробно. 
          Если чего-то не хватает, система задаст уточняющие вопросы на следующем шаге.
          Также можно написать "удиви меня" или "решай сам", чтобы AI создал мир самостоятельно.
        </Typography>
      </Paper>
    </Box>
  );
