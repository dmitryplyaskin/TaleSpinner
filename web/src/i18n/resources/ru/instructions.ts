const ruInstructions = {
	...
	actions: {
		...
		addCustomBlock: 'Добавить свой блок',
		resetCustomBlock: 'Сбросить форму',
	...
	fields: {
		...
		reorderBlocksHint: 'Перетаскивайте блоки, чтобы менять порядок. На handle также работают стрелки клавиатуры.',
		addStandardBlock: 'Стандартный блок',
		addCustomBlock: 'Свой блок',
		promptIdentifier: 'Identifier',
		promptName: 'Название блока',
		promptRole: 'Role',
		promptContent: 'Содержимое блока',
		markerLabel: 'marker',
		markerDescription: 'Для marker-блока пустое содержимое допустимо.',
		customBlockHint: 'Поля custom-блока сохраняются и экспортируются в формате SillyTavern.',
	...
	validation: {
		...
		promptIdentifierDuplicate: 'Блок с таким identifier уже существует.',
	},
	toasts: {
