const enInstructions = {
	...
	fields: {
		...
		promptPositionDescription: 'Relative keeps the block alongside other preset prompts, In-chat injects it into chat by depth.',
		promptPositionRelative: 'Relative',
		promptPositionInChat: 'In-chat',
		promptDepth: 'Depth',
		promptDepthDescription: '0 = after the last message, 1 = before the last message, etc.',
		promptOrder: 'Order',
		promptOrderDescription: 'Ordered from low/top to high/bottom; at the same order: Assistant, User, System.',
	...
	confirm: {
		...
		savePromptBlockChanges: 'This block has unsaved changes. Save them before closing?',
	...
	dialogs: {
		...
		editPromptBlockTitle: 'Edit block {{name}}',
		createPromptBlockTitle: 'Create block',
		savePromptBlockChangesTitle: 'Save block changes?',
